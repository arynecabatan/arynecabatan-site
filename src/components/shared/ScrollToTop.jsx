  ...
  return (
    <div className="relative bg-blue-900">
      <div
        ...
        className={`bg-spacecadet dark:bg-culturedwhite z-50 fixed bottom-4 right-4 md:bottom-20 p-3 rounded-xl shadow-lg transition-all cursor-pointer  ${
          scrollOnTop === true ? "opacity-0" : "opacity-100"
        }`}
      >
